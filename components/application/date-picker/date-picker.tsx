...
export const DatePicker = ({
    ...
    return (
        <AriaDatePicker shouldCloseOnSelect={false} {...props} value={value} onChange={setValue}>
            ...
            >
                <AriaDialog className="w-[328px] rounded-2xl bg-primary shadow-xl ring ring-secondary_alt">
                    {({ close }) => (
                        <>
                            <div className="flex px-6 py-5">
                                <Calendar highlightedDates={highlightedDates} todayLabel={todayLabel} weekdayLetterLen={weekdayLetterLen} />
                            </div>
