...
export const CustomRadarChartTick = ({ payload, x, y, textAnchor, stroke, radius = 0 }: CustomRadarChartTickProps) => {
    ...
    return (
        <Fragment>
            <rect ref={rectRef} x={xNum} y={yNum} rx={11} className="fill-utility-gray-50 stroke-utility-gray-200 stroke-1"></rect>
            <text
                ref={textRef}
                x={xNum}
                y={yNum + 5}
            ...
            >
                <tspan x={xNum} dy="0em" className="fill-utility-gray-700 text-xs font-medium">
                    {payload.value}
                </tspan>
            </text>
        </Fragment>
