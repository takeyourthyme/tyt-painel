    ...
    return (
        <AriaDialogTrigger>
            <header className="flex h-16 items-center justify-between border-b border-secondary bg-primary py-3 pr-2 pl-4 lg:hidden">
                <Link href="/dashboard" className="relative block h-10 w-[140px] shrink-0">
                    <Image src={logoSrc} alt="Take Your Thyme" fill className="object-contain object-left" sizes="140px" />
                </Link>
